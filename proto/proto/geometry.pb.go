...
func (x *PerimetrResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PerimetrResponse) ProtoMessage() {}

func (x *PerimetrResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_geometry_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PerimetrResponse.ProtoReflect.Descriptor instead.
func (*PerimetrResponse) Descriptor() ([]byte, []int) {
	return file_proto_geometry_proto_rawDescGZIP(), []int{2}
}

func (x *PerimetrResponse) GetResult() float32 {
	if x != nil {
		return x.Result
	}
	return 0
...
const file_proto_geometry_proto_rawDesc = "" +
	...
	"\x10PerimetrResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x02R\x06result2\x87\x01\n" +
	"\x0fGeometryService\x125\n" +
	"\x04Area\x12\x15.geometry.RectRequest\x1a\x16.geometry.AreaResponse\x12=\n" +
	"\bPerimetr\x12\x15.geometry.RectRequest\x1a\x1a.geometry.PerimetrResponseB3Z1github.com/grigoriy-st/grps-service-example/protob\x06proto3"
...
var file_proto_geometry_proto_goTypes = []any{
	...
	(*PerimetrResponse)(nil), // 2: geometry.PerimetrResponse
}
var file_proto_geometry_proto_depIdxs = []int32{
	0, // 0: geometry.GeometryService.Area:input_type -> geometry.RectRequest
	0, // 1: geometry.GeometryService.Perimetr:input_type -> geometry.RectRequest
	1, // 2: geometry.GeometryService.Area:output_type -> geometry.AreaResponse
	2, // 3: geometry.GeometryService.Perimetr:output_type -> geometry.PerimetrResponse
